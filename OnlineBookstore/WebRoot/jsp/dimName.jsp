...
<ul class="breadcrumbs">
 <div class="container">
     <li class="home">
         <span class="red" style="font-size: 20px"> &nbsp;查找图书：&nbsp;</span>
     </li>
 </div>
</ul>
<div>
<c:if test="${dimCount==1 }">
      <table  align="left" class="table" id="typebook" >
     <c:forEach items="${namebook}" var="shop">
        <tr >
...
<c:if test="${dimCount==0 }">
   <table height="300px">
    <tr>
     <h3 align="center"> 没有找到《${dimname}》，快去<a style="color: red" href="${pageContext.request.contextPath}/jsp/index.jsp">首页</a>看看吧！ </h3>
 	</tr>
   </table>
  </c:if> 
